...
1. Download the [script_init.bash](https://github.com/Zerrtified/arr-scripts/blob/main/radarr/scripts_init.bash) ([Download Link](https://raw.githubusercontent.com/Zerrtified/arr-scripts/main/radarr/scripts_init.bash)) and place it into the following folder: `/custom-cont-init.d`
...
1. Download/update your local `/config/extended.conf` file with the latest options from: [extended.conf](https://github.com/Zerrtified/arr-scripts/blob/main/radarr/extended.conf)
...
<table>
  <tr>
    <td><img src="https://raw.githubusercontent.com/Zerrtified/unraid-templates/master/Zerrtified/img/radarr.png" width="200"></td>
    <td><img src="https://github.com/Zerrtified/docker-lidarr-extended/raw/main/.github/plus.png" width="100"></td>
    <td><img src="https://raw.githubusercontent.com/Zerrtified/unraid-templates/master/Zerrtified/img/amtd.png" width="200"></td>
  </tr>
 </table>
...
For more details, visit the [Wiki](https://github.com/Zerrtified/arr-scripts/wiki)

### Plex Example

![amvtd](https://raw.githubusercontent.com/Zerrtified/docker-amtd/master/.github/amvtd-plex-example.jpg)
